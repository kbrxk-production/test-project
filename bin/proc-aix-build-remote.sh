...
printf "${GREEN}$ cd $WORK_DIR${NORMAL}\n"
cd $WORK_DIR
printf "${GREEN}make clean${NORMAL}\n"
make clean

printf "${GREEN}$ cd $WORK_DIR/$SERVICE_NAME${NORMAL}\n"
cd $WORK_DIR/$SERVICE_NAME
ls -l
...
cd "$WORK_DIR/$OUTPUT_DIR/$SERVICE_NAME"
